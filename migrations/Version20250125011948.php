...
final class Version20250125011948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('UPDATE setting SET context = "general_settings" WHERE name IN ("site_url", "site_title", "site_logo", "site_locale", "site_favicon", "pterodactyl_url", "pterodactyl_use_as_client_panel", "pterodactyl_api_key", "show_phpmyadmin_url", "phpmyadmin_url")');
        ...
        $this->addSql('UPDATE setting SET context = "theme_settings" WHERE name IN ("theme_default_primary_color", "theme_default_dark_primary_color", "customer_motd_enabled", "customer_motd_message", "customer_motd_title")');
