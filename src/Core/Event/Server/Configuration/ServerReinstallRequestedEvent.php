...
class ServerReinstallRequestedEvent extends AbstractDomainEvent
{
    ...
    public function isEggChange(): bool
    {
        return $this->selectedEgg !== null && $this->selectedEgg !== $this->currentEgg;
    }
